...
def band_average_overlap(swir_overlap_interp,
...
def main(vnir_path,
    ...
    swir_overlap_interp, swir_overlap_interp_wavelengths = interpolate_swir_to_vnir(swir_arr, swir_wavelengths, vnir_wavelengths)


    average_overlap_data, average_overlap_data_wavelengths = band_average_overlap(swir_overlap_interp,
                                                                                 swir_overlap_interp_wavelengths,
                                                                                 vnir_arr,
                                                                                 vnir_wavelengths)

    # fusing the three pieces together
    vnir_swir_fused_data, vnir_swir_fused_wavelengths = fuse_data(vnir_arr,
              vnir_wavelengths,
              average_overlap_data,
              average_overlap_data_wavelengths,
              swir_arr,
...
if __name__ == "__main__":
    ...
    main(vnir_path,swir_path, output_path)
