...
def coregister_manual(mica_path, mica_bands, hs_path, hs_bands, use_available_homography = False, name = ""):
    ...
    (mica_arr, mica_profile, _),\
        (hs_arr, hs_profile, hs_wavelengths) = load_mica_hdr_rasterio(mica_path, hs_path)
...
if __name__ == "__main__":
    ...
    mica_bands = [0,1,2]
    swir_path = "/Volumes/T7/axhcis/Projects/NURI/data/20210723_tait_labsphere/1133/Micasense/NURI_micasense_1133_transparent_mosaic_stacked_warped.hdr"
    swir_bands = [90,40,10]
