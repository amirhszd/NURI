...
def splash(vnir_hdr,
    ...
    # mica_hdr_u16, _ = convert_to_uint16(mica_hdr, out_folder)
    ...
    vnir_hdr_warped = "/Volumes/T7/axhcis/Projects/NURI/data/20210723_tait_labsphere/1133/out/raw_0_rd_wr_or_u16_warped_ss"
    mica_hdr_vnirres = "/Volumes/T7/axhcis/Projects/NURI/data/20210723_tait_labsphere/1133/out/raw_1504_nuc_rd_wr_or_u16_warped"

    # 3) run shapeshifter on both of the datasets
    print(" ")
    print(Color.BLUE + "------> Running Shape Shifter..." + Color.END)
    vnir_hdr_warped_ss, vnir_hdr_warped_ss_qa = shape_shift_mpp(vnir_hdr_warped, mica_hdr_vnirres,
    ...
    swir_hdr_warped_ss, swir_hdr_warped_ss_qa = shape_shift_mpp(swir_hdr_warped, mica_hdr_swirres,
                                                                pixel_shift=pixel_shift, kernel_size=kernel_size,
    ...
    vnir_hdr_warped_ss_reg = antspy_registration(vnir_hdr_warped_ss, mica_hdr_vnirres, hs_bands = ss_vnir_band_indices, mica_band = ss_vnir_mica_band_index)
    swir_hdr_warped_ss_reg = antspy_registration(swir_hdr_warped_ss, mica_hdr_swirres, hs_bands = ss_swir_band_indices, mica_band=ss_swir_mica_band_index)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        splash(args.vnir_hdr, args.swir_hdr, args.mica_hdr, args.outfolder,
        ...
        vnir_hdr = "/Volumes/T7/axhcis/Projects/NURI/data/20210723_tait_labsphere/1133/VNIR/raw_0_rd_wr_or.hdr"
        swir_hdr = "/Volumes/T7/axhcis/Projects/NURI/data/20210723_tait_labsphere/1133/SWIR/raw_1504_nuc_rd_wr_or.hdr"
        mica_hdr = "/Volumes/T7/axhcis/Projects/NURI/data/20210723_tait_labsphere/1133/Micasense/NURI_micasense_1133_transparent_mosaic_stacked.hdr"
        out_folder = "/Volumes/T7/axhcis/Projects/NURI/data/20210723_tait_labsphere/1133/out"
        use_torch = True
        num_threads = 8
        manual_warping = True
        use_homography = True
        # todo add an option to get rid of intermediate files
        splash(vnir_hdr, swir_hdr, mica_hdr, out_folder, use_torch, num_threads, manual_warping, use_homography)
